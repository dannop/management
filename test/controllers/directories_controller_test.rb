...
class DirectoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create directory" do
    assert_difference('Directory.count') do
      post directories_url, params: { directory: { name: @directory.name, user_id_id: @directory.user_id_id } }
    end
  ...
  test "should update directory" do
    patch directory_url(@directory), params: { directory: { name: @directory.name, user_id_id: @directory.user_id_id } }
